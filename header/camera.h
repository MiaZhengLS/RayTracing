...
public:
  camera(const point3 &look_from, const vec3 &look_dir, const vec3 &v_up, double aspect_ratio, int img_width, double focal_length, const int max_depth = 10, double vfov = 45);
